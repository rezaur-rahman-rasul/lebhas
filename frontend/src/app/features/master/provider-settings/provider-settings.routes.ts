...
export const MASTER_PROVIDER_SETTINGS_ROUTES: Routes = [
  {
    path: 'master/provider-management',
  ...
  {
    path: 'master/credit-adjustments',
    canActivate: [roleGuard(['MASTER'])],
    loadComponent: () => import('./pages/workspace-credit-adjustment-page/workspace-credit-adjustment-page').then((m) => m.WorkspaceCreditAdjustmentPage),
  },
];
