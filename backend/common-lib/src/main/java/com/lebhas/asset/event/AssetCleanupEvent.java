...
public record AssetCleanupEvent(
        String eventId,
        Instant occurredAt,
        UUID workspaceId,
        UUID assetId,
    ...
    public static AssetCleanupEvent from(AssetEntity asset, boolean storageReleased) {
        return new AssetCleanupEvent(
                null,
                null,
