...
public class SecurityConfiguration {
    ...
    private static final String[] PUBLIC_ENDPOINTS = {
            ...
            "/api/v1/auth/register/mobile/start",
            "/api/v1/auth/register/mobile/verify",
            "/api/v1/auth/register/email/skip",
            "/api/v1/auth/register/email/start",
            "/api/v1/auth/register/email/verify",
            "/api/v1/auth/register/password",
            "/api/v1/auth/register/brand",
            "/api/v1/auth/register/product-service",
            "/api/v1/auth/register/project-campaign",
            "/api/v1/auth/login",
            "/api/v1/auth/refresh",
            ...
            "/api/v1/payments/bkash/**",
            "/api/v1/payments/nagad/**",
            "/api/v1/payments/rocket/**",
    ...
    AccessTokenRevocationStore accessTokenRevocationStore(
        ...
        RedisAccessTokenRevocationStore redisStore =
                new RedisAccessTokenRevocationStore(redisSessionService, clock);
