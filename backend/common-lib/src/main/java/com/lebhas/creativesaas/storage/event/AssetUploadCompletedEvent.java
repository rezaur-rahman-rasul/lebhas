...
public record AssetUploadCompletedEvent(
        String eventId,
        Instant occurredAt,
        UUID workspaceId,
        UUID assetId,
    ...
    public AssetUploadCompletedEvent {
