...
public class PricingApiMapper {
    ...
    public PlanFeaturePolicyResponse toPlanFeaturePolicyResponse(PlanFeaturePolicyView view) {
        ...
        return new PlanFeaturePolicyResponse(
                ...
                view.maxProjects(),
                view.maxAssets(),
                view.maxCreativeRequests(),
                view.maxTeamMembers(),
                view.maxGeneratedVersionsPerCreativeRequest(),
                view.maxStorageGb(),
                view.maxStorageBytes(),
                view.monthlyCreditLimit(),
                view.promptEnhancementEnabled(),
                view.creativeGenerationEnabled(),
                view.allowApprovalWorkflow(),
                view.downloadEnabled(),
                view.shareEnabled(),
                view.allowPublicShareLinks(),
                view.assetUploadEnabled(),
                view.premiumQualityEnabled(),
                view.allowVideoGeneration(),
                view.voiceoverGenerationEnabled(),
                view.allowAdvancedPromptIntelligence(),
                view.allowTeamCollaboration(),
                view.allowExportWithoutWatermark(),
                view.enabledCreativeToolCodes(),
                view.createdAt(),
                view.updatedAt());
    }
